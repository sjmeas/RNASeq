...
# Activate the environment with pre-installed programs
source ~/miniconda2/bin/activate blat

# Download and unzip the target genome (one time)
...
# samtools faidx hg38.fa $(cat $genome_dir/chr_ids.txt) > $genome_dir/hg38.fa#mv hg38.fa $genome_dir
